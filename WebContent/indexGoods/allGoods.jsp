...
$(function(){
	...
	$("#a2").click(function(){
		...
		$(this).attr("href","/StoreOL/goods_toNextAllGoodsPage.action?page="+page);
		return true;
	});
	$("#a1").click(function(){
		if(page=="1"){
		...
		$(this).attr("href","/StoreOL/goods_toPrevAllGoodsPage.action?page="+page);
		return true;
	});
});
