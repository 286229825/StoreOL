...
<script type="text/javascript">
	$(function(){
		var goodsid=$("#hidd1").val();
		
		$("#ff").form("load","/StoreOL/goodsmanagerjson_getPrevInfo.action?id="+goodsid);
		...
		$("#cc").combobox({
			...
			onLoadSuccess:function(){
				var typeid=$("#hidd2").val();
				$("#cc").combobox("select",typeid);
			}
		});
...
<div style="margin-top:1%;font-weight:bold;float:left">
	<font size="3">当前位置 ： 商品管理 > 修改商品</font>
</div>
<input type="hidden" id="hidd2" name="goodsType.id" value="${param.typeid }">
<div style="margin-top:5%">
<center>
	<form id="ff" action="${pageContext.request.contextPath }/goodsmanager_updateGoods.action" method="post" enctype="multipart/form-data">
		<input type="hidden" id="hidd1" name="id" value="${param.id }">
