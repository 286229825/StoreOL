...
$(function(){
	...
	$("#a2").click(function(){
		...
		$(this).attr("href","/StoreOL/goods_toNextPage.action?page="+page);
		return true;
	});
	$("#a1").click(function(){
		if(page=="1"){
		...
		$(this).attr("href","/StoreOL/goods_toPrevPage.action?page="+page);
		return true;
	});
});

function myajax(page){
	var args={"page":page,"ifNew":"new"};
	$.ajax({
