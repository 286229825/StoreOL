...
$(function(){
	...
	$("#a2").click(function(){
		...
		$(this).attr("href","/StoreOL/goods_toNextRankPage.action?page="+page);
		return true;
	});
	$("#a1").click(function(){
		if(page=="1"){
		...
		$(this).attr("href","/StoreOL/goods_toPrevRankPage.action?page="+page);
		return true;
	});
});

function myajax(page){
	var args={"page":page,"buytimes":"buyTimes"};
	$.ajax({
...
function toWhichPage(){
	...
	window.open("/StoreOL/goods_toWhichRankPage.action?page="+page,"_self");
};
</script>
<input type="hidden" id="myhid" value="${sessionScope.customerName }">
<div style="margin-top:1%;float:left">
	<font color="blue" size="3" style="font-weight:bold">当前位置 ： 销售排行</font>
	<br id="p">
	<br>
	<br>
</div>
